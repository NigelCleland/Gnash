...
version = Gnash.__version__
# The full version, including alpha/beta/rc tags.
release = Gnash.__version__
...
latex_documents = [
  ('index', 'Gnash.tex', u'Gnash Documentation',
...
man_pages = [
    ('index', 'Gnash', u'Gnash Documentation',
     [u'Nigel Cleland'], 1)
]
...
texinfo_documents = [
  ('index', 'Gnash', u'Gnash Documentation',
   u'Nigel Cleland', 'Gnash', 'One line description of project.',
   'Miscellaneous'),
]
